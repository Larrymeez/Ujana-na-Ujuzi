...
export default function Hero() {
  ...
  return (
    <section className="text-center py-12 bg-red-50 rounded-lg shadow-md">
      ...
      >
        <p className="text-lg text-gray-600 italic font-bold transform transition duration-300 
      ...
      >
        <Link
          to="/contact"
          className="inline-block bg-red-600 text-white font-semibold px-6 py-3 rounded-lg shadow-md 
                     hover:bg-red-700 hover:scale-110 hover:shadow-xl transform transition duration-300"
        >
          Join Us
        </Link>
      </div>

      {/* Optional Subtext / Decorative */}
      <div
        className={`mt-4 transition-opacity duration-700 ${
